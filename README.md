...
## v0.9.8 097 Speed Core

- 以 v0.9.7 代码作为性能基线。
- 不改 TCP 测试核心，保留高速建连、FD 上限保护和失败数精准停止表现。
- 添加 release 签名配置，GitHub Actions 可使用 Secrets 自动生成 signed APK。
- workflow 使用 Gradle 8.10.2，不依赖仓库内 gradlew。
