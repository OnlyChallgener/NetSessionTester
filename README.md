...
## v0.9.8 Network Environment Refinement

- 网络环境卡删除“制式/4G/5G”字段，避免因 Android 权限和系统限制导致信息不准。
- 运营商显示优化：蜂窝网络优先显示 SIM/网络运营商；WiFi 或无法读取运营商时，按 IPv6 出口前缀粗略判断：
  - 2408：联通
  - 2409：移动
  - 240e：电信
- 新增“IPv6前缀”字段，保留出口地址可横向查看/复制的逻辑。
- 版本号保持不变。


## v0.9.8 Operator Display Refinement

- 网络环境卡不再显示“IPv6前缀”字段。
- WiFi 或蜂窝无法直接读取运营商时，仍会在后台根据 IPv6 出口前缀自动判定：
  - 2408：联通
  - 2409：移动
  - 240e：电信
- 界面只显示最终判定的运营商，减少冗余信息。
- 版本号保持不变。
